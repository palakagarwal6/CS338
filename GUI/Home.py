from db import connect_to_mysql, create_database_if_not_exists, populate_movies_table, create_movies_table, use_database, load_all_movies_from_db, check_table_exists, update_movie_details_in_db, delete_movie_from_db, delete_table
import os
